...
class Filters extends BaseFilters
{
    ...
    public array $aliases = [
        ...
        'optionalauth'    => \App\Filters\OptionalAuthFilter::class,
    ];
    ...
    public array $filters = [
        ...
        'firewall' => ['before' => ['api/*']],
        'invalidchars' => ['except' => ['api/uploads/*', 'admin/media/upload']], // Exclure les routes d'upload pour ne pas corrompre les données binaires multipart
